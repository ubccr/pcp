...
pcpmappingdict = {
	...
	'intel_snb_cbo': {
		'CLOCK_TICKS': {
			'name': 'perfevent.hwcounters.snbep_unc_cbo%d__UNC_C_CLOCKTICKS.value',
		...
		'COUNTER0_OCCUPANCY': {
			'name': 'perfevent.hwcounters.snbep_unc_cbo%d__UNC_C_COUNTER0_OCCUPANCY_e_t_1.value',
		...
		'LLC_LOOKUP': {
			'name': 'perfevent.hwcounters.snbep_unc_cbo%d__UNC_C_LLC_LOOKUP_DATA_READ.value',
		...
		'RxR_OCCUPANCY': {
			'name': 'perfevent.hwcounters.snbep_unc_cbo%d__UNC_C_RXR_OCCUPANCY_IRQ.value',
	...
	'intel_snb_imc': {
		'ACT_COUNT': {
			'name': 'perfevent.hwcounters.snbep_unc_imc%d__UNC_M_ACT_COUNT.value',
		...
		'CAS_READS': {
			'name': 'perfevent.hwcounters.snbep_unc_imc%d__UNC_M_CAS_COUNT_RD.value',
		...
		'CAS_WRITES': {
			'name': 'perfevent.hwcounters.snbep_unc_imc%d__UNC_M_CAS_COUNT_WR.value',
		...
		'CYCLES': {
			'name': 'perfevent.hwcounters.snbep_unc_imc%d__UNC_M_CLOCKTICKS.value',
		...
		'PRE_COUNT_MISS': {
			'name': 'perfevent.hwcounters.snbep_unc_imc%d__UNC_M_PRE_COUNT_PAGE_MISS.value',
	...
	'intel_snb_qpi': {
		'G1_DRS_DATA': {
			'name': 'perfevent.hwcounters.snbep_unc_qpi%d__UNC_Q_RXL_FLITS_G1_DRS_DATA.value',
		...
		'G2_NCB_DATA': {
			'name': 'perfevent.hwcounters.snbep_unc_qpi%d__UNC_Q_RXL_FLITS_G2_NCB_DATA.value',
		...
		'TxL_FLITS_G1_HOM': {
			'name': 'perfevent.hwcounters.snbep_unc_qpi%d__UNC_Q_TXL_FLITS_G1_HOM_NONREQ.value',
		...
		'TxL_FLITS_G1_SNP': {
			'name': 'perfevent.hwcounters.snbep_unc_qpi%d__UNC_Q_TXL_FLITS_G1_SNP.value',
